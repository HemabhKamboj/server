...
urlpatterns = [
    ...
    path('confirm-verification-code/<str:verification_code>',
         user_views.confirm_verification_code, name='confirm-verification-code'),
    ...
    path('update-trip-public/<int:trip_id>', trip_views.update_trip_public, name='update-trip-public'),
    path('update-trip-private/<int:trip_id>', trip_views.update_trip_private, name='update-trip-private'),
    ...
    path('get-ways-to-reach/road/<str:origin>/<str:destination>/<str:mode>', ways_views.get_ways_road, name="get-ways-road"),
